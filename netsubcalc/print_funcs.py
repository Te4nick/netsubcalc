...
from calc_funcs import netaddr, broadcast, hosts_ip_range, hosts_count, ip_class
from convert_funcs import (ip2bin,
                           mask2prefix,
                           ip2int_list,
                           int_list2ip)
from is_funcs import is_ip_private
...
def print_all_possible_subnets(ip: str, mask: str) -> None:
    ...
    :param ip: string decimal IP address
